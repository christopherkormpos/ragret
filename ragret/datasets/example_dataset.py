example_dataset = [
    {
        ...
        "context": ["Το καταστημα μας εχει κοσμηματα και χαντρες απο διαφορα ειδη ενα εκ των οποιων και το miyuki", 
    ...
    },
    {
        ...
        "context": ["Το email επικοινωνιας ειναι το marmero@gmail.com στο οποιο δεχομαστε και παραγγελειες", 
